  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Configure your Store Control app</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <div className="flex justify-between"><span>App</span><span className="font-medium text-foreground">Store Control</span></div>
