...
import {
  LayoutDashboard, Package, Warehouse, BarChart3, FileUp,
    ...
    <div className="flex flex-col h-full bg-sidebar text-sidebar-foreground">
      <div className="flex items-center gap-3 px-4 py-5 border-b border-sidebar-border">
        ...
        <div className="min-w-0">
          <h1 className="font-semibold text-sm truncate text-sidebar-foreground">Store Control</h1>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 border-b bg-card">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm">Store Control</span>
          </div>
        </div>
